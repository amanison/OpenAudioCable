...
//PSAVEWORKER_PARAM       CVCable::m_pWorkItems = NULL;
//PDEVICE_OBJECT          CVCable::m_pDeviceObject = NULL;
//=============================================================================
// Classes
//=============================================================================
#ifdef SYSVAD_BTH_BYPASS
...
--*/
{
    ...
    // (b/c of CVCable's static members and Bluetooth HFP logic).
    //
...
--*/
{
    ...
    //
    //CVCable::SetDeviceObject(DeviceObject);   //device object is needed by CVCable
    //ntStatus = CVCable::InitializeWorkItems(DeviceObject);
    //IF_FAILED_JUMP(ntStatus, Done);
Done:
